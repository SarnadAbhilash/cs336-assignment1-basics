...
from cs336_basics.nn import Linear, RMSNorm, SiLU, SwiGLU
from cs336_basics.embed import Embedding
...
def run_linear(
    ...
    """
    # 1. build a Linear
    # 2. load `weights` into its .weight.data
    # 3. return the forward pass on in_features
...
def run_rmsnorm(
    ...
    """
    # 1. build the module
    # 2. load weights into it
    # 3. return forward pass on in_features
